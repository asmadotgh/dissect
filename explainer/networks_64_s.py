...
#             print(':', inputs)
#             inputs = G_Resblock_Encoder("Encoder-ResBlock2", inputs, 512, y,
...
#             print(':', embedding)
#
#             inputs = G_Resblock("ResBlock1", embedding, 512, y, nums_class)  # [n, 32, 32, 512]
#             print(':', inputs)
#             inputs = G_Resblock("ResBlock2", inputs, 256, y, nums_class)  # [n, 64, 64, 256]
#             print(':', inputs)
